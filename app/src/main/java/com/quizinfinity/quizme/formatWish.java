...
public class formatWish {
    ...
    public formatWish(String imagequiz, String imageinstructor, String title, String qnnumber, String instructor, String price, String level, String description, String rating, String quizCode) {
