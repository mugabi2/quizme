...
//                                innerMap.put("title",fsTitle);
//                                innerMap.put("price",fsPrice);
//                                innerMap.put("photoUrl",fsPhoto);
//                                outerMap.put(Integer.toString(counter),innerMap);
//                                counter++;
//                                Log.d("44444 ", Integer.toString(counter));
...
//                            firestoreCallback.onCallback(requestArray);
                        ...
                        Log.d("5555", fsPhoto+fsInstructorPhotoUrl+fsTitle+fsNoOfquestions+fsInstructor+fsPrice+fsLevel+fsDescription+fsRating);
//                        mans=recycler1array.get(3);
...
//                multiple=abcdr*3;
//                Log.d("abcdr", Integer.toString(abcdr));
//                Log.d("abcdr", requestArray.toString());
//                Log.d("abcdr", Integer.toString(multiple));
//                sendable=requestArray.get(multiple);
//                request(requestArray.get(abcdr));
//                Log.d("abcdx", sendable);
